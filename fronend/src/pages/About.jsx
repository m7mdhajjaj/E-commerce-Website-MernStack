...
const About = () => {
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20 gap-0.5'>
  ...
  <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
    ...
    <p>We prioritize our customers' needs and preferences, ensuring a personalized shopping experience.</p>
  </div>
   <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
    <b>Convenience:</b>
    <p>We strive to make your shopping experience as seamless as possible, offering fast shipping and easy returns.</p>
  </div>
</div>
      <NewsLettersBox />
    </div>
